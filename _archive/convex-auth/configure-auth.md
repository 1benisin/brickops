# Configure Authentication Methods - Convex Auth

## Configure Authentication Methods

Now you need to choose how you want your users to authenticate.

If you're just getting started for the first time, we recommend using GitHub [OAuth](https://labs.convex.dev/auth/config/oauth). This is the simplest method to set up.

If you don't want to use any other service you can use [Passwords](https://labs.convex.dev/auth/config/passwords) without password recovery.
...
![example sign in forms](https://labs.convex.dev/auth/_next/image?url=%2Fauth%2F_next%2Fstatic%2Fmedia%2FexampleForms.22f83078.png&w=3840&q=75)

If you know which methods you want to support click on the links below and follow the method specific guide:

1.  [Magic Links](https://labs.convex.dev/auth/config/email) or [OTPs](https://labs.convex.dev/auth/config/otps) (send a link or code via email)
2.  [OAuth](https://labs.convex.dev/auth/config/oauth) (sign in with Github / Google / Apple etc.)
3.  [Passwords](https://labs.convex.dev/auth/config/passwords) (including password reset flow and optional email verification)

## Understand the tradeoffs[](#understand-the-tradeoffs)
...
### Magic Links & OTPs[](#magic-links--otps)
...
[Custom Schema](https://labs.convex.dev/auth/setup/schema "Custom Schema")
[OAuth](https://labs.convex.dev/auth/config/oauth "OAuth")
