...
export const testConnection = action({
  ...
  handler: async (ctx, args) => {
    ...
    const credential = await ctx.runQuery(internal.marketplace.mutations.getEncryptedCredentials, {
      businessAccountId,
      provider: args.provider,
    });
    ...
    try {
      if (args.provider === "bricklink") {
        ...
        await ctx.runMutation(internal.marketplace.mutations.updateValidationStatus, {
          businessAccountId,
          provider: args.provider,
