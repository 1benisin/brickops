...
export async function getCatalogItem(
  ...
  return await withBlClient(ctx, {
    ...
    fn: async (client) => {
      const response = await client.request<BLApiResponse<BLCatalogItemResponse>>({
...
export async function getCatalogItemColors(
  ...
  return await withBlClient(ctx, {
    businessAccountId: params.businessAccountId,
    fn: async (client) => {
      const response = await client.request<BLApiResponse<BLCatalogPartColorsResponse>>({
...
export async function getCatalogSupersets(
  ...
  return await withBlClient(ctx, {
    ...
    fn: async (client) => {
      ...
      const response = await client.request<BLApiResponse<BLCatalogSupersetsResponse>>({
...
export async function getCatalogSubsets(
  ...
  const identifier = blCatalogItemIdentifierSchema.parse(params.identifier);
  const options = params.options ? blCatalogSubsetsOptionsSchema.parse(params.options) : undefined;
  ...
  return await withBlClient(ctx, {
    ...
    fn: async (client) => {
      ...
      const response = await client.request<BLApiResponse<BLCatalogSubsetsResponse>>({
...
export async function getCatalogPriceGuide(
  ...
  return await withBlClient(ctx, {
    ...
    fn: async (client) => {
      ...
      const response = await client.request<BLApiResponse<BLCatalogPriceGuideResponse>>({
