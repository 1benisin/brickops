...
- Brickognize camera identification flows and error handling dictate the mock responses for camera-based tests. [Source: docs/architecture/api-brickognize.md#integration-notes; docs/architecture/api-brickognize.md#error-responses]
- Bricklink OAuth requirements and order payload structures shape the backend mock utilities. [Source: docs/architecture/api-bricklink.md#authentication--authorization; docs/architecture/api-bricklink.md#order-resource-representations]
- Brickowl catalog and store inventory endpoints define the request arguments and data permutations the mocks must support. [Source: docs/architecture/api-brickowl.md#catalog; docs/architecture/api-brickowl.md#store-inventory]
