...
- pnpm test:backend
- pnpm test:frontend
- pnpm test:e2e -- --project=chromium-desktop *(fails: local Node 16.17.0 incompatible with Next.js >= 18.17 requirement)*
...
- .env.local.example
- __tests__/backend/auth-password-reset-email.test.ts
