...
- Validate provider credentials via Convex env (`BRICKOGNIZE_API_KEY`). Never expose secrets to client. [Source: architecture/api-specification.md#brickognize-api-key]
